			...
			<!--<div class="marketingDiv widgetHeight">
				...
				{else}
					<div class="inActiveImgDiv">
						...
						<a href="http://billmaher.hbo.libsynpro.com/rss" target="_blank" style="margin-right: 25px;"><img src="layouts/v7/resources/Images/extensionstore.png" style="width: 85%; height: 100%; margin-top: 25px;"/></a>
					</div>
				{/if}
				</div>--!>
			</div>
